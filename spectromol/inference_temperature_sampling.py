...
if __name__ == "__main__":
    ...
    # smiles
    smiles_list = pd.read_csv('/data4/linkaiqing/sm_pretrained/gp/t50_drug_database/smiles.csv').values.tolist()
    ...
    results = inference_with_temperature_sampling_analysis(
        ...
        idx2char,
        max_seq_length=100,
        save_dir='/data4/linkaiqing/sm_pretrained/fangyang/gp/csv/corr_draw',
        temperatures=[0.6, 0.8, 1.0, 1.2, 1.5],
        num_candidates=50
    )
